...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-9BQGZB3ZV3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-9BQGZB3ZV3');
</script>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Tech Akiya</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body>
    <!-- Navigation -->
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-logo">
                <h2><a href="personl.html">Tech Akiya </a></h2>
            </div>
            <ul class="nav-menu">
  ...
  <h1 color= "yellow">
  <a href="student.html"><b>Form</b></a>
  <a href="payment.html"><b>Form</b></a> 
  </h1>
  ...
  <header class="navbar">
    <div class="logo-area">
      <!-- 🔴 Logo Image -->
      <img src="https://drive.google.com/uc?export=view&id=17h3JfLLFB2aOaviVEjW6ajkw-VoYrBpi" alt="Tech Akiya Logo">
      <span>Tech Akiya</span>
    </div>
  ...
  <section id="home" class="hero">
    ...
    <div class="hero-content">
      <!-- 🔴 Logo Image again -->
      <img class="hero-logo" src="https://drive.google.com/uc?export=view&id=17h3JfLLFB2aOaviVEjW6ajkw-VoYrBpi" alt="Tech Akiya Logo">
      <h1>Tech Akiya</h1>
      <p>Learn, Code & Level Up in Sinhala</p>
      <div class="hero-buttons">
        <a href="#videos" class="btn primary">▶ Watch Videos</a>
        <a href="#about" class="btn secondary">💻 Learn Tech</a>
      </div>
    </div>
  </section>
  ...
  <section id="about" class="about">
    <div class="about-content">
      <h2>About Tech Akiya</h2>
      <p>
        🇱🇰 <strong>සිංහල:</strong> Tech Akiya කියන්නේ සිංහලෙන් Technology, Coding, Apps, Websites, Online tools ගැන සරලව, පැහැදිලිව කියලා දෙන tech channel එකක්. Beginner කෙනෙක්ටත් easy වෙන්න Learn • Code • Level Up 🚀
      </p>
      <p>
        🇬🇧 <strong>English:</strong> Tech Akiya is a tech-focused channel that explains Technology, Coding, Websites, Apps, and Online Tools in a simple and beginner-friendly way. Our goal is to help you Learn, Code, and Level Up step by step 🚀
      </p>
    </div>
  </section>
